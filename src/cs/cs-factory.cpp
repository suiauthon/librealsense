...
namespace librealsense {
    ...
    std::vector<tagged_profile> d400e_camera::get_profiles_tags() const
    {
        ...
        markers.push_back({ RS2_STREAM_DEPTH, -1, -1, -1, RS2_FORMAT_ANY, -1, profile_tag::PROFILE_TAG_SUPERSET | profile_tag::PROFILE_TAG_DEFAULT });
        markers.push_back({ RS2_STREAM_COLOR, -1, -1, -1, RS2_FORMAT_ANY, -1, profile_tag::PROFILE_TAG_SUPERSET | profile_tag::PROFILE_TAG_DEFAULT });
        return markers;
    }
